...
const FOOTER_BG = '#2D2F34'

export default function Footer() {
  return (
    <footer style={{ backgroundColor: FOOTER_BG, color: '#fff', padding: '28px 40px' }}>
      <div
        style={{
          maxWidth: '1200px',
          margin: '0 auto',
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: '14px', alignItems: 'center' }}>
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill="white" aria-label="Instagram">
            ...
            <svg width="22" height="22" viewBox="0 0 24 24" fill="white" aria-label="Facebook">
