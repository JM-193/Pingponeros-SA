...
| **Observaciones** | _(espacio para anotaciones del observador)_ |
...
| **Observaciones** | Prestar especial atención a si el participante nota o no la redirección silenciosa, y si la falta de un mensaje explícito le genera confusión sobre si su clic funcionó. |
